...
```shell
curl "https://leasedesk.ptchr-dev.nl/api/v1/advertiser/create
    -X POST
...
--------- | -----------
ID | The ID of the advertiser to update as received by the create endpoint
...
Parameter | Description
--------- | -----------
ID | The ID of the advertiser to retrieve as received by the create endpoint
...
Parameter | Description
--------- | -----------
ID | The ID of the Advertiser to delete as received by the create endpoint